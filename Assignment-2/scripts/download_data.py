...
def download_and_setup_data(url):
    ...
    """
    # Base path is the root of Assignment-2/
    base_path = Path(__file__).parent.parent
    data_dir = base_path / "data" # Where we'll store all data
    assessment_dir = data_dir / "assessment" # The final folder for the assessment dataset
    zip_path = data_dir / "assessment.zip" # Temporary path for the zip file
...
if __name__ == "__main__":
    ...
    ########################################################################
    URL = "https://drive.google.com/file/d/1OF56Z23GUAOcRt_P6PSKp0wTNqrnvAxa/view?usp=share_link"
