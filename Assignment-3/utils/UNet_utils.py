...
"""
The following functions are based on the notebooks provided for the Nvidia course The following functions are based on the notebooks provided for the Nvidia course Generative AI with Diffusion Models https://learn.nvidia.com/courses/course-detail?course_id=course-v1:DLI+C-FX-08+V1 
